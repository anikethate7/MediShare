  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-250px)] py-8 md:py-12 animate-fade-in">
      <div className="text-center mb-8 md:mb-12">
        <h1 className="text-3xl md:text-5xl font-headline font-bold mb-3 md:mb-4 text-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full max-w-4xl">
        <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 group">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl md:text-3xl font-headline text-accent">Are you a Donor?</CardTitle>
            <CardDescription className="text-sm md:text-md text-foreground/70 pt-1 md:pt-2">
              Login or register to view active medicine requests from NGOs and offer your help.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <Button asChild size="lg" className="w-full md:w-auto bg-accent hover:bg-accent/90 text-base md:text-lg py-4 md:py-6">
        ...
        <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 group">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl md:text-3xl font-headline text-primary">Are you an NGO?</CardTitle>
            <CardDescription className="text-sm md:text-md text-foreground/70 pt-1 md:pt-2">
              Register or log in to manage your profile and post medicine donation requests.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <Button asChild size="lg" className="w-full md:w-auto bg-primary hover:bg-primary/90 text-base md:text-lg py-4 md:py-6">
              <Link href="/login-ngo">
